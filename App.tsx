...
const App: React.FC = () => {
    ...
    const renderPage = () => {
        switch (currentPage) {
            ...
            case Page.Settings: return <Settings token={botState.token} setToken={setToken} seniorAdminId={botState.seniorAdminId} setSeniorAdminId={setSeniorAdminId} isRunning={botState.isRunning} startBot={startBot} stopBot={stopBot} apiKey={apiKey} setApiKey={handleSetApiKey} />;
            ...
            case Page.AdminActions: return <AdminActions isAiAvailable={aiReady} />;
