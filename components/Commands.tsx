...
const Commands: React.FC<CommandsProps> = ({ commands, addCommand, removeCommand, isAiAvailable }) => {
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-2">
                         ...
                         {!isAiAvailable && <p className="text-xs text-yellow-400 mt-1">Please set your Gemini API Key in the Settings page to enable AI features.</p>}
                    </div>
                    <div>
